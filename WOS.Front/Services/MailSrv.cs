...
namespace WOS.Front.Services
{
    public class MailSrv : IMailSrv
    {
        ...
        public void SendDeliveryConfirmation(Commande commande)
        {
            ...
            // On génère un code à 6 chiffres aléatoire avec le timecode en plus
            Random random = new Random();
            int code = random.Next(100000, 999999);
            int timeCode = (int)(DateTime.Now - new DateTime(1970, 1, 1)).TotalSeconds;
            int codeWithTime = code * timeCode;
